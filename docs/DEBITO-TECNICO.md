...
| 6   | 36 issue + 19 warn di complessità residui (top: `shared.clickZoom` ccn 19 · `ClosingBubbles.update` 16 · `shared.pressButtonTweens` 14 · `heuristic.parseAmount` 13 · `ReportForm` 13) | scan 2026-07-12 | `shared.tsx`/`ClosingBubbles` li tocca R2 (motion): ridurre lì; gli altri opportunisticamente | media |
