...
const CALLOUTS: Callout[] = [
  { at: 0.26, hold: 0.06, x: "7%", y: "20%", kicker: "Connettore", value: "Type 2", sub: "Standard europeo · IEC 62196" },
  { at: 0.37, hold: 0.06, x: "52%", y: "16%", kicker: "Potenza AC", value: "fino a 7,4 kW", sub: "monofase · 32 A" },
  { at: 0.48, hold: 0.06, x: "9%", y: "56%", kicker: "Ideale per", value: "plug-in & city EV", sub: "ricarica notturna completa" },
  { at: 0.59, hold: 0.06, x: "52%", y: "50%", kicker: "Trifase", value: "fino a 22 kW", sub: "EV a ricarica rapida" },
  { at: 0.7, hold: 0.06, x: "11%", y: "70%", kicker: "Stato di carica", value: "45% → 80%" },
  { at: 0.81, hold: 0.13, x: "50%", y: "66%", kicker: "Tempo stimato", value: "~2h 10min", sub: "energia erogata 12,6 kWh" },
];
