    ...
    <Section id="mappa" size="wide">
      <div ref={sectionRef} className="max-w-2xl">
        ...
        <p className="text-muted mt-4 text-lg">
          Una selezione dei progetti GM Solar in nord Italia. Tocca un punto per potenza e anno; i
          gruppi si aprono con un click.
        </p>
      </div>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2">
        ...
        <Legend
          swatch={
            <span className="bg-accent text-accent-contrast grid size-4 place-items-center rounded-full border-2 border-white text-[0.5rem] font-bold">
              n
            </span>
          }
      ...
      <div className="border-border bg-brand-950 relative mt-8 h-[60vh] min-h-[420px] overflow-hidden rounded-xl border">
